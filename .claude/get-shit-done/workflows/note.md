...
- **Global scope**: `/Users/berndplontsch/PARAlocal/vibes/articles/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/berndplontsch/PARAlocal/vibes/articles/.claude/notes/`)
...
2. Glob `/Users/berndplontsch/PARAlocal/vibes/articles/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/berndplontsch/PARAlocal/vibes/articles/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/berndplontsch/PARAlocal/vibes/articles/.claude/notes/` — works in any directory
