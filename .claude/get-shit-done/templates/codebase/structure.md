...
- Usage: Reference from command with `@/Users/berndplontsch/PARAlocal/vibes/articles/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/berndplontsch/PARAlocal/vibes/articles/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/berndplontsch/PARAlocal/vibes/articles/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
